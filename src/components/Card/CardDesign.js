        ...
        <div className="bg-red-primary rounded-xl shadow-xl flex flex-col justify-between mt-4 w-72 md:mt-0 md:w-60 lg:w-80">
            <div className="bg-white flex mx-4 my-4 rounded-lg px-4 py-2 items-center" >
                ...
                <div className="md:ml-4">
                    <p className="font-bold text-base md:text-lg lg:text-2xl ">{name}</p>
                    <div className="flex items-center">
                        <p className="text-red-text text-sm md:text-lg ld:text-xl font-bold">Live</p>
                        <img src="/assets/card/cicle.png" alt="" className="ml-2 mt-1 w-2 h-2 md:w-3 md:h-3" />
                    </div>
                    <div className="flex items-center">
